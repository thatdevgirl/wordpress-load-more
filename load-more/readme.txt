...
This plugin supports pagination on a WordPress page via a "Load More" button.  Clicking on the button will add additioanl posts from a query to the bottom of the page in intervals set by the maximum number of posts option in the WordPress admin.
